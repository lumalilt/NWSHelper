...
public class PublicReleaseWorkflowTests
{
    ...
    public void PublicReleaseWorkflow_MsixAssetsAreOptInForGitHubReleases()
    {
        ...
        Assert.Contains("resolved_flight_id: ${{ steps.resolve-canary-flight.outputs.flight_id }}", canaryPrepareSection, StringComparison.Ordinal);
        Assert.Contains("PARTNER_CENTER_TENANT_ID: ${{ vars.PARTNER_CENTER_TENANT_ID || secrets.PARTNER_CENTER_TENANT_ID }}", canaryPrepareSection, StringComparison.Ordinal);
        Assert.Contains("PARTNER_CENTER_CLIENT_ID: ${{ vars.PARTNER_CENTER_CLIENT_ID || secrets.PARTNER_CENTER_CLIENT_ID }}", canaryPrepareSection, StringComparison.Ordinal);
        Assert.Contains("PARTNER_CENTER_CLIENT_SECRET: ${{ secrets.PARTNER_CENTER_CLIENT_SECRET }}", canaryPrepareSection, StringComparison.Ordinal);
        ...
        Assert.Contains("PARTNER_CENTER_CANARY_FLIGHT_NAME: ${{ vars.PARTNER_CENTER_CANARY_FLIGHT_NAME }}", canaryPrepareSection, StringComparison.Ordinal);
        Assert.Contains("Resolve canary flight ID", canaryPrepareSection, StringComparison.Ordinal);
        Assert.Contains("/listflights", canaryPrepareSection, StringComparison.Ordinal);
        Assert.Contains("Could not find Partner Center flight '$env:PARTNER_CENTER_CANARY_FLIGHT_NAME'", canaryPrepareSection, StringComparison.Ordinal);
        ...
        Assert.Contains("PARTNER_CENTER_CANARY_FLIGHT_ID: ${{ needs.partner-center-canary-prepare.outputs.resolved_flight_id }}", canarySubmitSection, StringComparison.Ordinal);
